...
class CrystalPlasticityBussoUpdateSingleSlipSys;

/**
 * CrystalPlasticityBussoUpdateSingleSlipSys uses the multiplicative decomposition of the
...
class CrystalPlasticityBussoUpdateSingleSlipSys : public CrystalPlasticityDislocationUpdateBase
{
public:
  static InputParameters validParams();

  CrystalPlasticityBussoUpdateSingleSlipSys(const InputParameters & parameters);
