...
[Mesh]
  ...
  [./box1]
    ...
    block_id = 1
    bottom_left = '0.00719 0.00206 0'
    top_right = '0.01013 0.00794 0'
  [../]
  [./box2]
    input = box1
    type = SubdomainBoundingBoxGenerator
    block_id = 2
    bottom_left = '0 0.00706 0'
    top_right = '0.00147 0.01 0'
  [../]
  [./box3]
    input = box2
    type = SubdomainBoundingBoxGenerator
    ...
    top_right = '0.00147 0.00294 0'
  [../]
  [./box4]
    input = box3
    type = SubdomainBoundingBoxGenerator
    block_id = 4
    bottom_left = '0.01585 0.00706 0'
  ...
  [./box5]
    ...
    type = SubdomainBoundingBoxGenerator
    block_id = 5
    bottom_left = '0.01585 0.0 0'
    top_right = '0.01732 0.00294 0'
  [../]
[]
