...
ConservativeSourceSink::validParams()
{
  ...
  params.addRequiredParam<int>("activated_quadrant",
  ...
  params.addCoupledVar("edge_dislo_1_Q1", 0.0,"The edge dislocation density of Quadrant 1 of Slip system 1");
  params.addCoupledVar("edge_dislo_1_Q3", 0.0,"The edge dislocation density of Quadrant 3 of Slip system 1");
  params.addCoupledVar("edge_dislo_2_Q1", 0.0,"The edge dislocation density of Quadrant 1 of Slip system 2");
  params.addCoupledVar("edge_dislo_2_Q3", 0.0,"The edge dislocation density of Quadrant 3 of Slip system 2");
    ...
    case SlipSystem::SLIP_SYSTEM_1:
      ...
      case DisloCharacter::edge:
        ...
        case DisloSign::positive:
          ...
          source = _Ce * _ke_b * std::sqrt(TotalDislocationDensity_ALL + _u[_qp]) * abs_slip_increment;
          sink = - _Ce / _burgers * 2.0 * _de * (temp_edge_dislo_den[0] + _u[_qp]) * abs_slip_increment;
          break;
        case DisloSign::negative:
      ...
      case DisloCharacter::screw:
        ...
        case DisloSign::positive:
          ...
          source = _Cs * _ks_b * std::sqrt(TotalDislocationDensity_ALL + _u[_qp]) * abs_slip_increment;
          sink = - _Cs / _burgers *
    ...
    case SlipSystem::SLIP_SYSTEM_2:
      ...
      case DisloCharacter::edge:
        ...
        case DisloSign::positive:
          ...
          source = _Ce * _ke_b * std::sqrt(TotalDislocationDensity_ALL + _u[_qp]) * abs_slip_increment;
          sink = - _Ce / _burgers * 2.0 * _de * (temp_edge_dislo_den[1] + _u[_qp]) * abs_slip_increment;
          break;
        case DisloSign::negative:
          // calculate the source and sink terms of negative screw dislocation density
    ...
    case SlipSystem::SLIP_SYSTEM_1:
      ...
      case DisloCharacter::edge:
        ...
        case DisloSign::positive:
          ...
          TotalDislocationDensity_ALL = TotalDislocationDensity_ALL - temp_dislo_den[0][0][0];
          temp_edge_dislo_den[0] = temp_edge_dislo_den[0] - temp_dislo_den[0][0][0];
          source = _Ce * _ke_b * 0.5 / std::sqrt(TotalDislocationDensity_ALL + _u[_qp]) * abs_slip_increment;
      ...
      case DisloCharacter::screw:
        ...
        case DisloSign::positive:
          ...
          TotalDislocationDensity_ALL = TotalDislocationDensity_ALL - temp_dislo_den[0][1][0];
          temp_screw_dislo_den[0] = temp_screw_dislo_den[0] - temp_dislo_den[0][1][0];
          source = _Cs * _ks_b * 0.5 / std::sqrt(TotalDislocationDensity_ALL + _u[_qp]) * abs_slip_increment;
          sink = - _Cs / _burgers *
                M_PI * std::pow(_ds, 2.0) * _ks_b * _burgers * 0.5 /
                     std::sqrt(TotalDislocationDensity_ALL + _u[_qp]) * temp_screw_dislo_den[0] * abs_slip_increment
                - _Cs / _burgers *
                M_PI * std::pow(_ds, 2.0) * _ks_b * _burgers *
                     std::sqrt(TotalDislocationDensity_ALL + _u[_qp]) * abs_slip_increment
                - _Cs / _burgers *
                 2.0 * _ds * abs_slip_increment;
          break;
        case DisloSign::negative:
          // calculate the source and sink terms of negative screw dislocation density
          TotalDislocationDensity_ALL = TotalDislocationDensity_ALL - temp_dislo_den[0][1][1];
    ...
    case SlipSystem::SLIP_SYSTEM_2:
      ...
      case DisloCharacter::screw:
        ...
        case DisloSign::positive:
          ...
          sink = - _Cs / _burgers *
                M_PI * std::pow(_ds, 2.0) * _ks_b * _burgers * 0.5 /
                     std::sqrt(TotalDislocationDensity_ALL + _u[_qp]) * temp_screw_dislo_den[1] * abs_slip_increment
                - _Cs / _burgers *
                M_PI * std::pow(_ds, 2.0) * _ks_b * _burgers *
                     std::sqrt(TotalDislocationDensity_ALL + _u[_qp]) * abs_slip_increment
                - _Cs / _burgers *
